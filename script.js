...
scrollTriggerAnimation(".article", [".article .label",".article .heading",".article .paragraph"]);


swipeAnimation(".destination",[".destination .heading", ".destination .content"]);
...
galleryAnimation(".featured .gallery",[".featured .gallery .box1",".featured .gallery .box2",
    ".featured .gallery .box3",".featured .gallery .box4",".featured .gallery .box5",".featured .gallery .box6"])

galleryAnimation(".feedback .voices",[".feedback .voices .box1",".feedback .voices .box2",
        ".feedback .voices .box3",".feedback .voices .box4",".feedback .voices .box5",".feedback .voices .box6"])
